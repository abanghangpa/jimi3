...
STRATEGY_CONFIGS = {
    ...
    "forced_movement": {"tp_pct": 2.0, "sl_pct": 1.5, "hold_hours": 4, "direction": None, "enabled": False, "group": "A", "min_conviction": 0.45, "notes": "DISABLED 2026-07-27: 8-agent forensic FAIL (1/5). MC p=0.99, CI includes zero. Basis fires 99.8% = noise. Only funding_squeeze sub-signal has edge (already standalone). Combination dilutes edge."},
